...
ActiveRecord::Schema.define(version: 2021_05_05_074441) do
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "ship_form_area_id", null: false
  ...
  create_table "shipping_locations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_purchase_id"], name: "index_shipping_locations_on_item_purchase_id"
  end
  ...
  add_foreign_key "shipping_locations", "item_purchases"
end
